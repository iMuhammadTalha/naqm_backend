...
module.exports.init = async function init() {
    try {
        ...
        const cors = function (req, res, next) {
            const whitelist = ['localhost:3000', 'http://localhost:3000', 'http://localhost:3001', 'http://localhost:3002', '111.68.101.14:3000', 'http://111.68.101.14:3001', 'http://111.68.101.14', 'http"//111.68.101.11', '111.68.101.11:3003'];
